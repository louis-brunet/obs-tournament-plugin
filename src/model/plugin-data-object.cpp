#include "plugin-data-object.hpp"

TournamentPluginDataObject::~TournamentPluginDataObject() {}

// #include <obs.hpp>
//
// template<class ObjectType>
// void TournamentPluginDataObject::loadArray(
...
// {
// 	OBSDataArrayAutoRelease defaultDataArray = obs_data_array_create();
// 	for (unsigned int index = 0; index < defaultDataItems.size(); index++) {
...
// 	OBSDataArrayAutoRelease dataArray = obs_data_get_array(dataObj, name);
//
//     // auto outputVector = new std::vector<ObjectType *>;
// 	for (unsigned int index = 0; index < obs_data_array_count(dataArray);
// 	     index++) {
...
//
// template<class ObjectType>
// void TournamentPluginDataObject::saveArray(
// 	obs_data_t *dataObj, const char *name,
